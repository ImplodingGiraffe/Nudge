...
That said, I am wary of taking lecture notes here instead of, say, Word since everything lives in browser storage. If your browser data gets cleared out and you haven't exported a backup, your notes sink with the ship. I realize that this is a rather large issue and have considered the File System Access API to save and read notes locally on your computer. But this is only supported on Chromium-based browsers. (I'm typing this on Firefox by the way.) 🥲
