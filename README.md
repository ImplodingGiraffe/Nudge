...
Nudge stores all your courses, tasks, plans, study sessions, and notes right in your browser's local storage. No data (except for manually triggered and optional Nudge AI) gets uploaded to the cloud.
